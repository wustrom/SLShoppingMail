...
namespace WxPayAPI
{
    public class OrderQuery : SingleTon<OrderQuery>
    {
        /// <summary>
        /// 订单查询完整业务流程逻辑
        /// </summary>
        /// <param name="transaction_id">transaction_id 微信订单号（优先使用）</param>
        /// <param name="out_trade_no">out_trade_no 商户订单号</param>
        /// <returns>订单查询结果</returns>
        public WxPayData Run(string transaction_id, string out_trade_no)
        {
