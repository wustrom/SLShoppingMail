...
namespace WxPayAPI
{
    public class JsApiPay
    {
	    ...
	    */
         ...
         * @失败时抛异常WxPayException
         */
        public WxPayData GetUnifiedOrderResult(string strBody, string out_trade_no)
        {
            //统一下单
            WxPayData data = new WxPayData();
            ...
            log.Error($"appid:{result.IsSet("appid")}");
            log.Error($"prepay_id:{result.IsSet("prepay_id")}");
            log.Error($"prepay_idStr:{result.GetValue("prepay_id").ToString()}");
        ...
        */
        public WxPayData GetJsApiParameters()
        {
            ...
            jsApiParam.SetValue("nonceStr", unifiedOrderResult.GetValue("nonceStr") != null ? unifiedOrderResult.GetValue("nonceStr").ToString() : WxPayApi.GenerateNonceStr());
