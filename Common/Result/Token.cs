...
namespace Common.Result
{
    public class Token
    {
        ...
        public string GetToken()
        {
            ...
            var SignatureString = Common.Helper.MD5Helper.StrToMD5(result + secret);
        ...
        public bool Validate(string tokenString)
        {
            ...
            {
                var SignatureString = Common.Helper.MD5Helper.StrToMD5(Token_Part[0] + "." + Token_Part[1] + secret);
