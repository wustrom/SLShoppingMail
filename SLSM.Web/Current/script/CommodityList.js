    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            for (var i = 0; i < listData.length; i++) {
                ...
                h += '<li><div class="imgbox"><a href="../../diy/index?Commodityid=' + comm.id + '"><img src="' + image + '" alt="" /></a></div><div class="content"><h2 class="h2tit"><div class="s1"><a href="../../diy/index?Commodityid=' + comm.id + '">' + name + '</a></div><div class="s2">' + starsStr + '</div><div class="s3">' + price + '</div></h2><div class="dewc"><div class="de1">' + intro + '</div><div class="de2">最小数量 ' + minAmount + '</div></div></div></li>'
            }
            var e = $('.prolist ul')
            e.children().remove();
            e.append(h);
