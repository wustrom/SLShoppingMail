...
{
    public partial class ChangestorageFunc : SingleTon<ChangestorageFunc>
    {
        /// <summary>
        /// 根据主键删除数据
        /// </summary>
        ...
        {
            return ChangestorageOper.Instance.DeleteById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public Changestorage SelectById(int KeyId)
        {
            return ChangestorageOper.Instance.SelectById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public List<Changestorage> SelectByKeys(string Key, List<string> KeyId)
        {
            return ChangestorageOper.Instance.SelectByKeys(Key,KeyId);
        }
        /// <summary>
        /// 根据分页筛选数据
        /// </summary>
