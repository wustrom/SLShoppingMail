...
namespace DbOpertion.Function
{
    public partial class CustomerserviceFunc : SingleTon<CustomerserviceFunc>
    {
        ...
        {
            return CustomerserviceOper.Instance.DeleteById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public Customerservice SelectById(int KeyId)
        {
            return CustomerserviceOper.Instance.SelectById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public List<Customerservice> SelectByKeys(string Key, List<string> KeyId)
        {
            return CustomerserviceOper.Instance.SelectByKeys(Key,KeyId);
        }
        /// <summary>
        /// 根据分页筛选数据
        /// </summary>
