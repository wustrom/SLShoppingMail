...
{
    public partial class Receive_MaterialsFunc : SingleTon<Receive_MaterialsFunc>
    {
        /// <summary>
        /// 根据主键删除数据
        /// </summary>
        ...
        {
            return Receive_MaterialsOper.Instance.DeleteById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public Receive_Materials SelectById(int KeyId)
        {
            return Receive_MaterialsOper.Instance.SelectById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public List<Receive_Materials> SelectByKeys(string Key, List<string> KeyId)
        {
            return Receive_MaterialsOper.Instance.SelectByKeys(Key,KeyId);
        }
        /// <summary>
        /// 根据分页筛选数据
        /// </summary>
