...
{
    public partial class Receive_Order_ViewFunc : SingleTon<Receive_Order_ViewFunc>
    {
        /// <summary>
        /// 筛选全部数据
        /// </summary>
        ...
        public Receive_Order_View SelectById(int KeyId)
        {
            return Receive_Order_ViewOper.Instance.SelectById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public List<Receive_Order_View> SelectByKeys(string Key, List<string> KeyId)
        {
            return Receive_Order_ViewOper.Instance.SelectByKeys(Key,KeyId);
        }
        /// <summary>
        /// 根据分页筛选数据
        /// </summary>
