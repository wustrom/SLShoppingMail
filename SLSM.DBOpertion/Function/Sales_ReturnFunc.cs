...
{
    public partial class Sales_ReturnFunc : SingleTon<Sales_ReturnFunc>
    {
        /// <summary>
        /// 根据主键删除数据
        /// </summary>
        ...
        {
            return Sales_ReturnOper.Instance.DeleteById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public Sales_Return SelectById(int KeyId)
        {
            return Sales_ReturnOper.Instance.SelectById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public List<Sales_Return> SelectByKeys(string Key, List<string> KeyId)
        {
            return Sales_ReturnOper.Instance.SelectByKeys(Key,KeyId);
        }
        /// <summary>
        /// 根据分页筛选数据
        /// </summary>
