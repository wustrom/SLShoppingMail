...
namespace DbOpertion.Function
{
    public partial class OrderdetaildesignFunc : SingleTon<OrderdetaildesignFunc>
    {
        ...
        {
            return OrderdetaildesignOper.Instance.DeleteById(KeyId);
        }
        ...
        /// <param name="model">模型</param>
        /// <returns>对象列表</returns>
        public int SelectCount(Orderdetaildesign model)
        {
            return OrderdetaildesignOper.Instance.SelectCount(model);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public Orderdetaildesign SelectById(int KeyId)
        {
            return OrderdetaildesignOper.Instance.SelectById(KeyId);
        }
        ...
        /// <param name="KeyId">主键Id</param>
        /// <returns>是否成功</returns>
        public List<Orderdetaildesign> SelectByKeys(string Key, List<string> KeyId)
        {
            return OrderdetaildesignOper.Instance.SelectByKeys(Key,KeyId);
        }
        /// <summary>
        /// 根据分页筛选数据
        /// </summary>
        ...
        /// <returns>对象列表</returns>
        public List<Orderdetaildesign> SelectByPage(string Key, int start, int PageSize, bool desc, Orderdetaildesign model, string SelectFiled)
        {
