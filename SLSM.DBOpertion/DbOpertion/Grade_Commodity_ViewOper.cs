...
{
    public partial class Grade_Commodity_ViewOper : SingleTon<Grade_Commodity_ViewOper>
    {
        /// <summary>
        /// 筛选全部数据
        /// </summary>
        ...
        public List<Grade_Commodity_View> SelectAll(Grade_Commodity_View model = null, string SelectFiled = null, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Grade_Commodity_View>();
            if (model != null)
            {
        ...
        /// <param name="transaction">事务</param>
        /// <returns>对象列表</returns>
        public int SelectCount(Grade_Commodity_View model = null, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Grade_Commodity_View>();
            if (model != null)
            {
        ...
        public Grade_Commodity_View SelectById(int KeyId, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Grade_Commodity_View>();
        ...
        /// <param name="transaction">事务</param>
        /// <returns>是否成功</returns>
        public List<Grade_Commodity_View> SelectByKeys(string Key,List<string> KeyIds, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Grade_Commodity_View>();
        ...
        /// <param name="transaction">事务</param>
        /// <returns>对象列表</returns>
        public List<Grade_Commodity_View> SelectByPage(string Key, int start, int PageSize, bool desc = true,Grade_Commodity_View model = null, string SelectFiled = null, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Grade_Commodity_View>();
            if (model != null)
            {
