...
namespace DbOpertion.Operation
{
    public partial class Commodity_Stageprice_ViewOper : SingleTon<Commodity_Stageprice_ViewOper>
    {
        ...
        public List<Commodity_Stageprice_View> SelectAll(Commodity_Stageprice_View model = null, string SelectFiled = null, IDbConnection connection = null, IDbTransaction transaction = null)
        {
        ...
        public Commodity_Stageprice_View SelectById(int KeyId, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Commodity_Stageprice_View>();
        ...
        /// <param name="transaction">事务</param>
        /// <returns>是否成功</returns>
        public List<Commodity_Stageprice_View> SelectByKeys(string Key,List<string> KeyIds, IDbConnection connection = null, IDbTransaction transaction = null)
        {
            var query = new LambdaQuery<Commodity_Stageprice_View>();
            ...
            if("maxprice" == Key.ToLowerInvariant())
            {
                query.Where(p => p.maxPrice.In(KeyIds));
            }
            if("minamount" == Key.ToLowerInvariant())
            {
                query.Where(p => p.minAmount.In(KeyIds));
            }
