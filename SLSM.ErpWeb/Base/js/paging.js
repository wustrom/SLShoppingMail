...
layui.define(['layer', 'laypage', 'laytpl'], function (exports) {
    ...
    Paging.prototype.get = function (options) {
        ...
        //默认参数
        var df = {
            pageIndex: _config.params.pageIndex == undefined ? 1 : _config.params.pageIndex,
            pageSize: _config.pageConfig.pageSize
        };
        ...
        $.ajax({
            ...
            success: function (result, status, xhr) {
                ...
                if (result.rel) {
                    ...
                    $(_config.elem).html('<tr><td colspan="' + thLength + '" style="text-align:center;">' + result.msg + '</td></tr>');
                    if (_config.fail) {
	 ...
	 * @param {Object} options
	 */
    Paging.prototype.ajaxPost = function (url, data, successfn) {
