...
$(document).ready(function () {
    ...
    $('img').each(function () {
        $(this).css('height', $(this)[0].width + "px");
    });
});
...
function EditImage(ImageId) {
    ...
    $.get('../MainShow/OnLineDetail', obj, function (form) {
        ...
        BoxIndex = layer.open({
            ...
            success: function (layero, index) {
                ...
                form.on('submit(edit)', function (data) {
                    jQuery.axpost('../../api/MainShow/ChangeOnlineGallery', JSON.stringify(data.field), function (dataInfo) {
                        layer.close(index);
