...
$(document).ready(function () {
    ...
    $('body').delegate('.ra', 'change', function () {
        var e = $(this).parent();
        if (!e.hasClass('xl1')) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (listData.length == 0) {
                ...
                var image = '/current/images/icon/norecord.png';
                $('.product-list ul li').remove();
                var h = '<li><div class="img"><a href="#"><img src="' + image + '" alt=""></a></div><div class="info"><h6>暂无有关 ' + text + ' 的商品</h6></div></li>'
                var h2 = '<li><img src="' + image + '" alt="">暂无有关 ' + text + ' 的商品</li>';
                $('.product-list ul').append(h);
                return;
            }
