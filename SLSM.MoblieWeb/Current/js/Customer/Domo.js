/// <reference path="../../../../slsm.web/current/js/customer/demo-1.4.13.js" />
...
//userpwd = document.getElementById("UserId").value;
////usernames = 'zhangsan';
////userpwd = '1001';
//var options = {
//    apiUrl: WebIM.config.apiURL,
...
usernames = document.getElementById("UserName").value;
if (usernames == "") {
    var GuiId = document.getElementById("GuiId").value;
    var registeroptions = {
        username: GuiId,
        password: GuiId,
        nickname: GuiId,
...
// 添加好友
    ...
    conn.subscribe({
        to: serviceName            // Demo里面接收方没有展现出来这个message，在status字段里面
    });
...
//          //  direction: "outgoing",
//            to: GuiId, //接收人的username或者接收group的ID
//            from: usernames, //发送人username
...
//                        type: "txt",
//                        url: "",
//                        dilename: "22.png",//不同的消息类型，bodies数据格式见如下几条
//                    }
//                ],
//                ext: { //自定义扩展属性
...
var reConn = function () {
    ...
    //    xmppURL: 'im-api-vip5.easemob.com',
    //    apiUrl: (location.protocol === 'https:' ? 'https:' : 'http:') + '//a1-vip5.easemob.com',
    //    appKey: "1145180404177595#sailong",
    //    user: "10vip5",
    //    pwd: "123456"
    //};
    //conn.open(options)
